# Generated by Django 3.1 on 2020-08-21 12:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='DEFAULT', max_length=50, verbose_name='НАЗВАНЕ ОПЕРАЦИИ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('table', models.FileField(null=True, upload_to='TABLES', verbose_name='ТАБЛИЦА')),
                ('qr_code_list', models.FileField(null=True, upload_to='QR_CODE_LIST', verbose_name='ФАЙЛ С КОДАМИ')),
                ('draw_archive', models.FileField(null=True, upload_to='DRAW_ARCHIVE', verbose_name='АРХИВ С PDF ЧЕРТЕЖАМИ')),
                ('archive_ready', models.BooleanField(default=False, verbose_name='ГОТОВНОСТЬ PDF АРХИВА')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='DEFAULT', max_length=100, verbose_name='МЕСТО ХРАНЕНИЯ')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stockage_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MainApp.stockagecode', verbose_name='МЕСТО ХРАНЕНИЯ')),
            ],
        ),
        migrations.AddField(
            model_name='order',
